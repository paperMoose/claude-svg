...
const ReactTest = ({
  ...
  return /*#__PURE__*/jsxRuntimeExports.jsx("se-button", {
    id: "hello_world",
    title: "Hello World",
    src: "hello_world.svg",
    onClick: onClick
...
var index = {
  ...
  async init() {
    return {
      name,
      eventBased: true,
      // if eventbased is true, the extensions needs to listen to svgedit events
      callback() {
        // position the div used by React in the left bar
        document.getElementById('tools_left').append(div);
        root.render(/*#__PURE__*/jsxRuntimeExports.jsx(ReactTest, {
          svgEdit: this,
          trigger: "callback"
        }));
      }
